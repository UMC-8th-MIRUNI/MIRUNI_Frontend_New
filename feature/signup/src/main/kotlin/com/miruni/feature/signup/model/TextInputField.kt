...
// --- 기본 String proxy ---
val TextInputField.text: String
    get() = value

val TextInputField.trimmed: String
    get() = value.trim()

val TextInputField.length: Int
    get() = value.length
...
// --- 숫자 관련 ---
val TextInputField.digits: String
    get() = value.filter(Char::isDigit)
...
fun TextInputField.isDigitsLengthIn(range: IntRange): Boolean =
    digits.length in range
